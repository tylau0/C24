...
for plisting in allPermutations(13):
    totalComboCnt += 1
    ...
    for r in possibleResults:
        ...
        comboCounts[result_str].append(plisting)
        
print("Total number of 4-number permutations: " + str(totalComboCnt))  
for key in comboCounts.keys():
    print("Result: " + str(key) + ' Permutations: ' + str(len(comboCounts[key])))
